...
const SearchBar = ({onSubmit,onReset,placeHolder,searchQuery}:Props) => {
  ...
  return (
    <Form {...form}>
        ...
        className={`flex items-centerflex-1 gap-3 justify-between flex-row border-2 rounded-full p-3 mx-5 ${form.formState.errors.searchQuery && "border-red-500"}`}
        >
            ...
            <Button
            type="submit"
            className="rounded-full bg-green-500 md:mt-0 sm:tracking-tighter" 
            >
                Search
            </Button>
