...
const ImageSection = () => {
    ...
    // console.log("watchfields",watchedFields);

    const kitchenImage = watch("kitchenImage")
    // console.log("existingImageUrl" , kitchenImage);
    // console.log("control", control);

  return (
    <div className="apace-y-2 mt-10">
      <div>
      ...
      <div className="flex flex-col gap-8 md:w-[50%]">
        {kitchenImage && (
            <AspectRatio ratio={16 / 9}>
                <img src={kitchenImage} className="rounded-md object-cover h-full w-full"/>
            </AspectRatio>
        )}
